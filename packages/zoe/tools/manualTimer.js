...
import { TimeMath, toTimestamp, toRelativeTime } from '@agoric/swingset-vat';
...
export default function buildManualTimer(log, startValue = 0n, timeStep = 1n) {
  startValue = toTimestamp(startValue);
  timeStep = toRelativeTime(timeStep);
  ...
  const timer = Far('ManualTimer', {
    ...
    delay(delay) {
      ...
      // https://github.com/Agoric/agoric-sdk/issues/5810
